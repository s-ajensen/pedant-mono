...
(def ws-handlers
  {
   :user/fetch-data 'pedant.auth/ws-fetch-user-data
   })
...
(def dev-handler
  (lazy-routes
    {
     ;["/sandbox" :get]                 pedant.sandbox.core/index
     ;["/sandbox/" :get]                pedant.sandbox.core/index
     ;["/sandbox/:page" :get]           pedant.sandbox.core/handler
     ;["/sandbox/:page/:ns" :get]       pedant.sandbox.core/handler
     ;["/sandbox/:page/:ns1/:ns2" :get] pedant.sandbox.core/handler
     }))
